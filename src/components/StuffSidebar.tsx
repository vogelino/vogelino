import { type Accessor, type JSXElement, type Setter, createEffect, createMemo } from 'solid-js'
			...
			>
				<button
					...
					class={classNames(
						...
						'hover-hover:hover:bg-grayLight hover-hover:hover:text-fg w-fit focusable',
